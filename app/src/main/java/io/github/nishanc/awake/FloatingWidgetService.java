...
/**
 * Created by Nishan Chathuranga on 3/29/2018.
 */
...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    private ImageView remove_image_view,small_icon;
    ...
    //--------------------Initialize WakeLock----------------------//
    PowerManager.WakeLock mScreenWakeLock = null;
    ...
    public void onCreate() {
        ...
        mScreenWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK,"widget-screen-wakelock");
        mScreenWakeLock.setReferenceCounted(false);
        mScreenWakeLock.acquire();
        Toast.makeText(getApplicationContext(), "Keeping screen on..",
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        aSwitch = (Switch) mFloatingWidgetView.findViewById(R.id.my_switch);
        small_icon = (ImageView) mFloatingWidgetView.findViewById(R.id.floating_widget_image_view);
        //Add the view to the window.
    ...
    private void implementClickListeners() {
        ...
        mFloatingWidgetView.findViewById(R.id.my_switch).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.close_floating_view:
                ...
                stopSelf();
                Toast.makeText(getApplicationContext(), "Screen will turn off..",
            ...
            case R.id.my_switch:
                ...
                if (aSwitch.isChecked()){
                    small_icon.startAnimation(rotation);
...
//               if (isChecked == true) { // The switch is enabled
//
//                   //--------------------------ACQUIRE WAKELOCK--------------------------//
//                   mScreenWakeLock.acquire();
//                   Toast.makeText(getApplicationContext(), "ON",
//                           Toast.LENGTH_SHORT).show();
//               } else if(isChecked == false){ // The switch is disabled
//
//                   //--------------------------RELEASE WAKELOCK--------------------------//
//                   mScreenWakeLock.release();
